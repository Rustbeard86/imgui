...
IMGUI_IMPL_API bool     ImGui_ImplXcb_Init(/*xcb_connection_t**/ void* connection);
...
extern IMGUI_IMPL_API int ImGui_ImplXcb_EventHandler(xcb_generic_event_t *event, xcb_generic_event_t *next_event);
#endif
